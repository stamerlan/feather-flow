...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            examples:
              ...
              pyplaner planner.html --watch
                  Watch for changes and rebuild HTML automatically."""),
    )
    ...
    parser.add_argument("--watch", action="store_true", default=False,
        help="watch the template and asset files for changes and "
             "automatically rebuild the HTML output "
             "(requires the 'livereload' package)")
    ...
    # --watch implies HTML-only output.
    if args.watch:
    ...
    if args.watch:
        try:
            ...
            print(
                "Error: the 'livereload' package is required "
                "for --watch mode.\n"
                "Install it with: pip install pyplaner[watch]",
                file=sys.stderr,
            )
            sys.exit(1)
        run_watch(args.file, calendar, pathlib.Path(args.html))
        return
